...
with col_chon:
    thang_chon = st.selectbox("📌 Chọn kỳ xuất bản:", [
        "Bản tin Tháng 7/2026",  # <--- Thêm tháng 7 lên đầu tiên để làm mặc định
        "Bản tin Tháng 6/2026",  
...
thu_vien_link = {
    ...
    "Bản tin Tháng 7/2026": "https://online.fliphtml5.com/zwykz/BAN-TIN-SINH-HOAT-CHI-BO-THANG-7-2026/",
